...
class TestV1beta1ClusterTrainingRuntime(unittest.TestCase):
    """V1beta1ClusterTrainingRuntime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1beta1ClusterTrainingRuntime:
        """Test V1beta1ClusterTrainingRuntime
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `V1beta1ClusterTrainingRuntime`
        """
        model = V1beta1ClusterTrainingRuntime()
        if include_optional:
            return V1beta1ClusterTrainingRuntime(
                api_version = '',
                kind = '',
                metadata = None,
    ...
    def testV1beta1ClusterTrainingRuntime(self):
        """Test V1beta1ClusterTrainingRuntime"""
