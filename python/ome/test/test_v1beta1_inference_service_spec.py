...
class TestV1beta1InferenceServiceSpec(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1InferenceServiceSpec:
        """Test V1beta1InferenceServiceSpec
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `V1beta1InferenceServiceSpec`
        """
        model = V1beta1InferenceServiceSpec()
        if include_optional:
