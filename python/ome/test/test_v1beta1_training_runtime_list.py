...
class TestV1beta1TrainingRuntimeList(unittest.TestCase):
    """V1beta1TrainingRuntimeList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1beta1TrainingRuntimeList:
        """Test V1beta1TrainingRuntimeList
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `V1beta1TrainingRuntimeList`
        """
        model = V1beta1TrainingRuntimeList()
        if include_optional:
            return V1beta1TrainingRuntimeList(
                api_version = '',
                items = [
                    ome.models.v1beta1/training_runtime.v1beta1.TrainingRuntime(
                        api_version = '', 
                        kind = '', 
                        metadata = None, 
    ...
    def testV1beta1TrainingRuntimeList(self):
        """Test V1beta1TrainingRuntimeList"""
