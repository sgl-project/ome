...
class TestV1beta1TrainingRuntime(unittest.TestCase):
    """V1beta1TrainingRuntime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1beta1TrainingRuntime:
        """Test V1beta1TrainingRuntime
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `V1beta1TrainingRuntime`
        """
        model = V1beta1TrainingRuntime()
        if include_optional:
            return V1beta1TrainingRuntime(
                api_version = '',
                kind = '',
                metadata = None,
    ...
    def testV1beta1TrainingRuntime(self):
        """Test V1beta1TrainingRuntime"""
