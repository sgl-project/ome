...
class TestV1beta1SupportedRuntime(unittest.TestCase):
    """V1beta1SupportedRuntime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1beta1SupportedRuntime:
        """Test V1beta1SupportedRuntime
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `V1beta1SupportedRuntime`
        """
        model = V1beta1SupportedRuntime()
        if include_optional:
            return V1beta1SupportedRuntime(
                name = '',
    ...
    def testV1beta1SupportedRuntime(self):
        """Test V1beta1SupportedRuntime"""
