...
class TestV1beta1BaseModel(unittest.TestCase):
    """V1beta1BaseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1beta1BaseModel:
        """Test V1beta1BaseModel
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `V1beta1BaseModel`
        """
        model = V1beta1BaseModel()
        if include_optional:
            return V1beta1BaseModel(
                api_version = '',
                kind = '',
                metadata = None,
