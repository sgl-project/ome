...
class TestV1beta1InferenceService(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1InferenceService:
        """Test V1beta1InferenceService
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `V1beta1InferenceService`
        """
        model = V1beta1InferenceService()
        if include_optional:
