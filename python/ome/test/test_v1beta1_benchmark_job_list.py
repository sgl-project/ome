...
class TestV1beta1BenchmarkJobList(unittest.TestCase):
    """V1beta1BenchmarkJobList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1beta1BenchmarkJobList:
        """Test V1beta1BenchmarkJobList
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `V1beta1BenchmarkJobList`
        """
        model = V1beta1BenchmarkJobList()
        if include_optional:
            return V1beta1BenchmarkJobList(
                api_version = '',
                items = [
                    ome.models.v1beta1/benchmark_job.v1beta1.BenchmarkJob(
                        api_version = '', 
                        kind = '', 
                        metadata = None, 
    ...
    def testV1beta1BenchmarkJobList(self):
        """Test V1beta1BenchmarkJobList"""
