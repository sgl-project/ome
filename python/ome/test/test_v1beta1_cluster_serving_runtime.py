...
class TestV1beta1ClusterServingRuntime(unittest.TestCase):
    """V1beta1ClusterServingRuntime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1beta1ClusterServingRuntime:
        """Test V1beta1ClusterServingRuntime
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `V1beta1ClusterServingRuntime`
        """
        model = V1beta1ClusterServingRuntime()
        if include_optional:
            return V1beta1ClusterServingRuntime(
                api_version = '',
                kind = '',
                metadata = None,
    ...
    def testV1beta1ClusterServingRuntime(self):
        """Test V1beta1ClusterServingRuntime"""
