...
class TestV1beta1ServingRuntimeSpec(unittest.TestCase):
    """V1beta1ServingRuntimeSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1beta1ServingRuntimeSpec:
        """Test V1beta1ServingRuntimeSpec
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `V1beta1ServingRuntimeSpec`
        """
        model = V1beta1ServingRuntimeSpec()
        if include_optional:
            return V1beta1ServingRuntimeSpec(
                affinity = None,
                annotations = {
                    'key' : ''
                    },
    ...
    def testV1beta1ServingRuntimeSpec(self):
        """Test V1beta1ServingRuntimeSpec"""
