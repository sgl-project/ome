...
class TestV1beta1ClusterTrainingRuntimeList(unittest.TestCase):
    """V1beta1ClusterTrainingRuntimeList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1beta1ClusterTrainingRuntimeList:
        """Test V1beta1ClusterTrainingRuntimeList
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `V1beta1ClusterTrainingRuntimeList`
        """
        model = V1beta1ClusterTrainingRuntimeList()
        if include_optional:
            return V1beta1ClusterTrainingRuntimeList(
                api_version = '',
                items = [
                    ome.models.v1beta1/cluster_training_runtime.v1beta1.ClusterTrainingRuntime(
                        api_version = '', 
                        kind = '', 
                        metadata = None, 
                        spec = ome.models.v1beta1/training_runtime_spec.v1beta1.TrainingRuntimeSpec(
                            annotations = {
                                'key' : ''
                                }, 
                            compartment_id = '', 
    ...
    def testV1beta1ClusterTrainingRuntimeList(self):
        """Test V1beta1ClusterTrainingRuntimeList"""
