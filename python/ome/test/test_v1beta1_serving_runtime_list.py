...
class TestV1beta1ServingRuntimeList(unittest.TestCase):
    """V1beta1ServingRuntimeList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1beta1ServingRuntimeList:
        """Test V1beta1ServingRuntimeList
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `V1beta1ServingRuntimeList`
        """
        model = V1beta1ServingRuntimeList()
        if include_optional:
            return V1beta1ServingRuntimeList(
                api_version = '',
                items = [
                    ome.models.v1beta1/serving_runtime.v1beta1.ServingRuntime(
                        api_version = '', 
                        kind = '', 
                        metadata = None, 
    ...
    def testV1beta1ServingRuntimeList(self):
        """Test V1beta1ServingRuntimeList"""
