...
class V1beta1PodOverride(BaseModel):
    ...
    env: Optional[List[V1EnvVar]] = Field(default=None, description="List of environment variables to set in the container.")
    env_from: Optional[List[V1EnvFromSource]] = Field(default=None, description="List of sources to populate environment variables in the container.", alias="envFrom")
    image: Optional[StrictStr] = Field(default=None, description="Image specifies the container image to use for the benchmark job.")
    ...
    __properties: ClassVar[List[str]] = ["affinity", "env", "envFrom", "image", "nodeSelector", "resources", "tolerations", "volumeMounts", "volumes"]
