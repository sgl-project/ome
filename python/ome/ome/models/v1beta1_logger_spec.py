...
class V1beta1LoggerSpec(object):
    ...
    """
    openapi_types = {"mode": "str", "url": "str"}

    attribute_map = {"mode": "mode", "url": "url"}
    ...
    def url(self):
        ...
        URL to send logging events The endpoint where log data will be sent for external processing or storage.  # noqa: E501
