...
class V1beta1ModelSpec(BaseModel):
    ...
    fine_tuned_weights: Optional[List[StrictStr]] = Field(
        default=None, alias="fineTunedWeights"
    )
    ...
    storage_uri: Optional[StrictStr] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "fineTunedWeights": obj.get("fineTunedWeights"),
                "image": obj.get("image"),
                "imagePullPolicy": obj.get("imagePullPolicy"),
                "lifecycle": V1Lifecycle.from_dict(obj["lifecycle"])
                if obj.get("lifecycle") is not None
                else None,
                "livenessProbe": V1Probe.from_dict(obj["livenessProbe"])
                if obj.get("livenessProbe") is not None
                else None,
                "name": obj.get("name") if obj.get("name") is not None else "",
                "ports": [V1ContainerPort.from_dict(_item) for _item in obj["ports"]]
                if obj.get("ports") is not None
                else None,
                "protocolVersion": obj.get("protocolVersion"),
                "readinessProbe": V1Probe.from_dict(obj["readinessProbe"])
                ...
                "securityContext": V1SecurityContext.from_dict(obj["securityContext"])
                if obj.get("securityContext") is not None
                else None,
                "startupProbe": V1Probe.from_dict(obj["startupProbe"])
