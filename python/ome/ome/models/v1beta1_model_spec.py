...
class V1beta1ModelSpec(BaseModel):
    ...
    fine_tuned_weights: Optional[List[StrictStr]] = Field(default=None, alias="fineTunedWeights")
    ...
    storage_uri: Optional[StrictStr] = Field(default=None, description="This field points to the location of the model which is mounted onto the pod.", alias="storageUri")
    ...
    __properties: ClassVar[List[str]] = ["args", "baseModel", "command", "env", "envFrom", "fineTunedWeights", "image", "imagePullPolicy", "lifecycle", "livenessProbe", "name", "ports", "protocolVersion", "readinessProbe", "resizePolicy", "resources", "restartPolicy", "runtime", "runtimeVersion", "securityContext", "startupProbe", "stdin", "stdinOnce", "storageUri", "terminationMessagePath", "terminationMessagePolicy", "tty", "volumeDevices", "volumeMounts", "workingDir"]
