...
class V1beta1IngressConfig(BaseModel):
    ...
    """ # noqa: E501
    additional_ingress_domains: Optional[List[StrictStr]] = Field(default=None, alias="additionalIngressDomains")
    disable_ingress_creation: Optional[StrictBool] = Field(default=None, alias="disableIngressCreation")
    ...
    __properties: ClassVar[List[str]] = ["additionalIngressDomains", "disableIngressCreation", "disableIstioVirtualHost", "domainTemplate", "ingressClassName", "ingressDomain", "ingressGateway", "ingressService", "localGateway", "localGatewayService", "pathTemplate", "urlScheme"]
