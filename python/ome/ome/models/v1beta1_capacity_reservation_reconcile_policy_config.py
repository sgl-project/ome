...
class V1beta1CapacityReservationReconcilePolicyConfig(BaseModel):
    """
    V1beta1CapacityReservationReconcilePolicyConfig
    """  # noqa: E501

    reconcile_failed_lifecycle_state: Optional[StrictBool] = Field(
        default=None, alias="reconcileFailedLifecycleState"
    )
    __properties: ClassVar[List[str]] = ["reconcileFailedLifecycleState"]
