...
class V1beta1StorageSpec(BaseModel):
    ...
    key: Optional[StrictStr] = Field(
        default=None, description="The Storage Key in the secret for this model."
    )
    ...
    schema_path: Optional[StrictStr] = Field(
        default=None,
        description="The path to the model schema file in the storage.",
        alias="schemaPath",
    )
    storage_uri: StrictStr = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "key": obj.get("key"),
                "nodeAffinity": V1NodeAffinity.from_dict(obj["nodeAffinity"])
