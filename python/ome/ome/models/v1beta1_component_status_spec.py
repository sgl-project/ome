...
class V1beta1ComponentStatusSpec(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["address", "latestCreatedRevision", "latestReadyRevision", "latestRolledoutRevision", "previousRolledoutRevision", "restURL", "traffic", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "address": KnativeAddressable.from_dict(obj["address"]) if obj.get("address") is not None else None,
            ...
            "restURL": KnativeURL.from_dict(obj["restURL"]) if obj.get("restURL") is not None else None,
            "traffic": [KnativeDevServingPkgApisServingV1TrafficTarget.from_dict(_item) for _item in obj["traffic"]] if obj.get("traffic") is not None else None,
