...
class V1beta1DecoderSpec(BaseModel):
    ...
    canary_traffic_percent: Optional[StrictInt] = Field(
        default=None,
    ...
    container_concurrency: Optional[StrictInt] = Field(
        default=None,
    ...
    containers: Optional[List[V1Container]] = Field(
        default=None,
        description="List of containers belonging to the pod. Containers cannot currently be added or removed. There must be at least one container in a Pod. Cannot be updated.",
    )
    deployment_strategy: Optional[K8sIoApiAppsV1DeploymentStrategy] = Field(
        default=None, alias="deploymentStrategy"
    )
    ...
    leader: Optional[V1beta1LeaderSpec] = None
    ...
    overhead: Optional[Dict[str, ResourceQuantity]] = Field(
        default=None,
    ...
    worker: Optional[V1beta1WorkerSpec] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V1beta1DecoderSpec from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V1beta1DecoderSpec from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "deploymentStrategy": K8sIoApiAppsV1DeploymentStrategy.from_dict(
                    obj["deploymentStrategy"]
                )
                if obj.get("deploymentStrategy") is not None
                else None,
                "dnsConfig": V1PodDNSConfig.from_dict(obj["dnsConfig"])
                ...
                "kedaConfig": V1beta1KedaConfig.from_dict(obj["kedaConfig"])
                if obj.get("kedaConfig") is not None
                else None,
                "labels": obj.get("labels"),
                "leader": V1beta1LeaderSpec.from_dict(obj["leader"])
                if obj.get("leader") is not None
                else None,
                "logger": V1beta1LoggerSpec.from_dict(obj["logger"])
                ...
                "runner": V1beta1RunnerSpec.from_dict(obj["runner"])
                if obj.get("runner") is not None
                else None,
                ...
                "securityContext": V1PodSecurityContext.from_dict(
                    obj["securityContext"]
                )
                ...
                "worker": V1beta1WorkerSpec.from_dict(obj["worker"])
