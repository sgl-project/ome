...
class V1beta1InferenceRouter(object):
    ...
    """
    openapi_types = {"router_type": "str", "steps": "list[V1beta1InferenceStep]"}
    ...
    def __init__(self, router_type="", steps=None, local_vars_configuration=None):  # noqa: E501
        """V1beta1InferenceRouter - a model defined in OpenAPI"""  # noqa: E501
    ...
    def router_type(self):
        """Gets the router_type of this V1beta1InferenceRouter.  # noqa: E501
        ...
        :return: The router_type of this V1beta1InferenceRouter.  # noqa: E501
        :rtype: str
        """
    ...
    def router_type(self, router_type):
        """Sets the router_type of this V1beta1InferenceRouter.

        RouterType  - `Sequence:` chain multiple inference steps with input/output from previous step  - `Splitter:` randomly routes to the target service according to the weight  - `Ensemble:` routes the request to multiple models and then merge the responses  - `Switch:` routes the request to one of the steps based on condition  # noqa: E501

        :param router_type: The router_type of this V1beta1InferenceRouter.  # noqa: E501
        :type: str
        """
    ...
    @property
    def steps(self):
        """Gets the steps of this V1beta1InferenceRouter.  # noqa: E501

        Steps defines destinations for the current router node  # noqa: E501

        :return: The steps of this V1beta1InferenceRouter.  # noqa: E501
        :rtype: list[V1beta1InferenceStep]
        """
        return self._steps

    @steps.setter
    def steps(self, steps):
        """Sets the steps of this V1beta1InferenceRouter.

        Steps defines destinations for the current router node  # noqa: E501

        :param steps: The steps of this V1beta1InferenceRouter.  # noqa: E501
        :type: list[V1beta1InferenceStep]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1beta1InferenceRouter):
            return False
