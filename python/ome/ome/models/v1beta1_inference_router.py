        ...
        _obj = cls.model_validate(
            {
                ...
                if obj.get("routerType") is not None
                else "",
                "steps": [
                    V1beta1InferenceStep.from_dict(_item) for _item in obj["steps"]
                ]
