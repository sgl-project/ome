...
class V1beta1InferenceRouter(BaseModel):
    """
    ...
    steps: Optional[List[V1beta1InferenceStep]] = Field(default=None, description="Steps defines destinations for the current router node")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "steps": [V1beta1InferenceStep.from_dict(_item) for _item in obj["steps"]] if obj.get("steps") is not None else None
        })
        return _obj
