...
class V1beta1EndpointSpec(BaseModel):
    ...
    inference_service: Optional[V1beta1InferenceServiceReference] = Field(default=None, alias="inferenceService")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "endpoint": V1beta1Endpoint.from_dict(obj["endpoint"]) if obj.get("endpoint") is not None else None,
            "inferenceService": V1beta1InferenceServiceReference.from_dict(obj["inferenceService"]) if obj.get("inferenceService") is not None else None
        })
        return _obj
