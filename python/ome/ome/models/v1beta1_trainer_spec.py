...
class V1beta1TrainerSpec(BaseModel):
    """
    V1beta1TrainerSpec
    """  # noqa: E501
    ...
    command: Optional[List[StrictStr]] = Field(
        default=None, description="Entrypoint commands for the training container."
    )
    ...
    image: Optional[StrictStr] = Field(
        default=None, description="Docker image for the training container."
    )
    num_nodes: Optional[StrictInt] = Field(
        default=None, description="Number of training nodes.", alias="numNodes"
    )
    num_proc_per_node: Optional[StrictStr] = Field(
        default=None,
        ...
        alias="numProcPerNode",
    )
    resources_per_node: Optional[V1ResourceRequirements] = Field(
        default=None, alias="resourcesPerNode"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "resourcesPerNode": V1ResourceRequirements.from_dict(
                    obj["resourcesPerNode"]
                )
                if obj.get("resourcesPerNode") is not None
                else None,
            }
        )
        return _obj
