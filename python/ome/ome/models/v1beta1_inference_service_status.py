...
class V1beta1InferenceServiceStatus(BaseModel):
    ...
    components: Optional[Dict[str, V1beta1ComponentStatusSpec]] = Field(
        default=None, description="Statuses for the components of the InferenceService"
    )
    conditions: Optional[List[KnativeCondition]] = Field(
        default=None,
        description="Conditions the latest available observations of a resource's current state.",
    )
    model_status: Optional[V1beta1ModelStatus] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "conditions": [
                    KnativeCondition.from_dict(_item) for _item in obj["conditions"]
                ]
                if obj.get("conditions") is not None
                else None,
                "modelStatus": V1beta1ModelStatus.from_dict(obj["modelStatus"])
                if obj.get("modelStatus") is not None
                else None,
