...
class V1beta1InferenceStep(BaseModel):
    ...
    condition: Optional[StrictStr] = Field(
        default=None, description="routing based on the condition"
    )
    ...
    name: Optional[StrictStr] = Field(
        default=None, description="Unique name for the step within this node"
    )
    ...
    service_url: Optional[StrictStr] = Field(
        default=None,
