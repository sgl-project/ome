...
class V1beta1FineTunedWeight(BaseModel):
    """
    ...
    spec: Optional[V1beta1FineTunedWeightSpec] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1beta1FineTunedWeightSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
