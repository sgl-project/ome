...
class V1beta1ServingRuntimePodSpec(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["affinity", "annotations", "containers", "dnsPolicy", "hostIPC", "hostNetwork", "imagePullSecrets", "labels", "nodeSelector", "schedulerName", "tolerations", "volumes"]
