...
class V1beta1ServiceAccount(BaseModel):
    ...
    spec: Optional[V1beta1ServiceAccountSpec] = None
    status: Optional[V1beta1ServiceAccountStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1beta1ServiceAccountSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": V1beta1ServiceAccountStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
