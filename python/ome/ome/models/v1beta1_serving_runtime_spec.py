...
class V1beta1ServingRuntimeSpec(BaseModel):
    ...
    router_config: Optional[V1beta1RouterSpec] = Field(default=None, alias="routerConfig")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of router_config
        if self.router_config:
            _dict['routerConfig'] = self.router_config.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "routerConfig": V1beta1RouterSpec.from_dict(obj["routerConfig"]) if obj.get("routerConfig") is not None else None,
