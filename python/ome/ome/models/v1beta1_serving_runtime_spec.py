...
class V1beta1ServingRuntimeSpec(BaseModel):
    ...
    built_in_adapter: Optional[V1beta1BuiltInAdapter] = Field(
        default=None, alias="builtInAdapter"
    )
    ...
    decoder_config: Optional[V1beta1DecoderSpec] = Field(
        default=None, alias="decoderConfig"
    )
    disabled: Optional[StrictBool] = Field(
        default=None, description="Set to true to disable use of this runtime"
    )
    ...
    engine_config: Optional[V1beta1EngineSpec] = Field(
        default=None, alias="engineConfig"
    )
    ...
    http_data_endpoint: Optional[StrictStr] = Field(
        default=None,
        description="HTTP endpoint for inferencing",
        alias="httpDataEndpoint",
    )
    ...
    model_size_range: Optional[V1beta1ModelSizeRangeSpec] = Field(
        default=None, alias="modelSizeRange"
    )
    ...
    pipeline_parallelism: Optional[StrictBool] = Field(
        default=None,
        ...
        alias="pipelineParallelism",
    )
    protocol_versions: Optional[List[StrictStr]] = Field(
        default=None,
    ...
    router_config: Optional[V1beta1RouterSpec] = Field(
        default=None, alias="routerConfig"
    )
    ...
    supported_model_formats: Optional[List[V1beta1SupportedModelFormat]] = Field(
        default=None,
        description="Model formats and version supported by this runtime",
        alias="supportedModelFormats",
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "builtInAdapter": V1beta1BuiltInAdapter.from_dict(obj["builtInAdapter"])
                if obj.get("builtInAdapter") is not None
                else None,
                ...
                "decoderConfig": V1beta1DecoderSpec.from_dict(obj["decoderConfig"])
                if obj.get("decoderConfig") is not None
                else None,
                "disabled": obj.get("disabled"),
                "dnsPolicy": obj.get("dnsPolicy"),
                "engineConfig": V1beta1EngineSpec.from_dict(obj["engineConfig"])
                if obj.get("engineConfig") is not None
                else None,
                ...
                "modelSizeRange": V1beta1ModelSizeRangeSpec.from_dict(
                    obj["modelSizeRange"]
                )
                if obj.get("modelSizeRange") is not None
                else None,
                ...
                "routerConfig": V1beta1RouterSpec.from_dict(obj["routerConfig"])
                if obj.get("routerConfig") is not None
                else None,
                "schedulerName": obj.get("schedulerName"),
                "supportedModelFormats": [
                    V1beta1SupportedModelFormat.from_dict(_item)
                    for _item in obj["supportedModelFormats"]
                ]
                if obj.get("supportedModelFormats") is not None
                else None,
                "tolerations": [
                ...
                "workers": V1beta1WorkerPodSpec.from_dict(obj["workers"])
