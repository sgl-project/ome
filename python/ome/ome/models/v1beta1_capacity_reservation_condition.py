...
class V1beta1CapacityReservationCondition(BaseModel):
    ...
    last_transition_time: Optional[V1Time] = Field(
    ...
    reason: Optional[StrictStr] = Field(
        default=None, description="Reason for the condition's last transition."
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "lastTransitionTime": V1Time.from_dict(obj["lastTransitionTime"])
                if obj.get("lastTransitionTime") is not None
                else None,
