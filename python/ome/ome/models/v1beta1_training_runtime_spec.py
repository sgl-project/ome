...
class V1beta1TrainingRuntimeSpec(BaseModel):
    ...
    pod_group_policy: Optional[V1beta1PodGroupPolicy] = Field(
        default=None, alias="podGroupPolicy"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "mlPolicy": V1beta1MLPolicy.from_dict(obj["mlPolicy"])
                if obj.get("mlPolicy") is not None
                else None,
                "podGroupPolicy": V1beta1PodGroupPolicy.from_dict(obj["podGroupPolicy"])
                if obj.get("podGroupPolicy") is not None
                else None,
                "template": V1beta1JobSetTemplateSpec.from_dict(obj["template"])
