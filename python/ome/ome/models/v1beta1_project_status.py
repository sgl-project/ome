...
class V1beta1ProjectStatus(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of last_updated_time
        if self.last_updated_time:
            _dict["lastUpdatedTime"] = self.last_updated_time.to_dict()
        return _dict
        ...
        _obj = cls.model_validate(
            {
                ...
                "creationTime": V1Time.from_dict(obj["creationTime"])
                if obj.get("creationTime") is not None
                else None,
                "lastUpdatedTime": V1Time.from_dict(obj["lastUpdatedTime"])
                if obj.get("lastUpdatedTime") is not None
                else None,
                "projectId": obj.get("projectId")
                if obj.get("projectId") is not None
                else "",
            }
        )
        return _obj
