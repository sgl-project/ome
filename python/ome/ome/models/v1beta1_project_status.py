...
class V1beta1ProjectStatus(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lastUpdatedTime": V1Time.from_dict(obj["lastUpdatedTime"]) if obj.get("lastUpdatedTime") is not None else None,
            "projectId": obj.get("projectId") if obj.get("projectId") is not None else ''
        })
        return _obj
