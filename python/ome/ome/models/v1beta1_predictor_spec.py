...
class V1beta1PredictorSpec(BaseModel):
    ...
    worker_spec: Optional[V1beta1WorkerSpec] = Field(default=None, alias="workerSpec")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of worker_spec
        if self.worker_spec:
            _dict["workerSpec"] = self.worker_spec.to_dict()
        return _dict
        ...
        _obj = cls.model_validate(
            {
                ...
                "model": V1beta1ModelSpec.from_dict(obj["model"])
                ...
                "workerSpec": V1beta1WorkerSpec.from_dict(obj["workerSpec"])
                if obj.get("workerSpec") is not None
                else None,
            }
        )
        return _obj
