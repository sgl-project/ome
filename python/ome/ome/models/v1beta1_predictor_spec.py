...
class V1beta1PredictorSpec(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["activeDeadlineSeconds", "affinity", "annotations", "automountServiceAccountToken", "canaryTrafficPercent", "containerConcurrency", "containers", "deploymentStrategy", "dnsConfig", "dnsPolicy", "enableServiceLinks", "ephemeralContainers", "hostAliases", "hostIPC", "hostNetwork", "hostPID", "hostUsers", "hostname", "imagePullSecrets", "initContainers", "kedaConfig", "labels", "logger", "maxReplicas", "minReplicas", "model", "nodeName", "nodeSelector", "os", "overhead", "preemptionPolicy", "priority", "priorityClassName", "readinessGates", "resourceClaims", "restartPolicy", "runtimeClassName", "scaleMetric", "scaleTarget", "schedulerName", "schedulingGates", "securityContext", "serviceAccount", "serviceAccountName", "setHostnameAsFQDN", "shareProcessNamespace", "subdomain", "terminationGracePeriodSeconds", "timeoutSeconds", "tolerations", "topologySpreadConstraints", "volumes", "workerSpec"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "model": V1beta1ModelSpec.from_dict(obj["model"]) if obj.get("model") is not None else None,
            ...
            "workerSpec": V1beta1WorkerSpec.from_dict(obj["workerSpec"]) if obj.get("workerSpec") is not None else None
        })
        return _obj
