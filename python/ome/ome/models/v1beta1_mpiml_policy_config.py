...
class V1beta1MPIMLPolicyConfig(BaseModel):
    """
    MPIMLPolicyConfig represents a MPI runtime configuration.
    """  # noqa: E501

    mpi_implementation: Optional[StrictStr] = Field(
        default=None,
