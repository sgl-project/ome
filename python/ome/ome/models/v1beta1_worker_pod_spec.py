...
class V1beta1WorkerPodSpec(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["affinity", "annotations", "containers", "dnsPolicy", "hostIPC", "hostNetwork", "imagePullSecrets", "labels", "nodeSelector", "schedulerName", "size", "tolerations", "volumes"]
