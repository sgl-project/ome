...
class V1beta1PodGroupPolicy(BaseModel):
    """
    PodGroupPolicy represents a PodGroup configuration for gang-scheduling.
    """  # noqa: E501

    coscheduling: Optional[V1beta1CoschedulingPodGroupPolicyConfig] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "coscheduling": V1beta1CoschedulingPodGroupPolicyConfig.from_dict(
                    obj["coscheduling"]
                )
                if obj.get("coscheduling") is not None
                else None
            }
        )
        return _obj
