...
class V1beta1HuggingFaceSecretReference(BaseModel):
    """
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default='', description="Name of the secret containing the Hugging Face API key. The secret must reside in the same namespace as the BenchmarkJob.")
