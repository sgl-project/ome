...
class V1beta1JobSetTemplateSpec(BaseModel):
    """
    JobSetTemplateSpec represents a template of the desired JobSet.
    """ # noqa: E501
    metadata: Optional[V1ObjectMeta] = None
    spec: Optional[SigsK8sIoJobsetApiJobsetV1alpha2JobSetSpec] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": SigsK8sIoJobsetApiJobsetV1alpha2JobSetSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None
        })
        return _obj
