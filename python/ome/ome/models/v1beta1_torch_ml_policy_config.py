...
class V1beta1TorchMLPolicyConfig(BaseModel):
    ...
    elastic_policy: Optional[V1beta1TorchElasticPolicy] = Field(
        default=None, alias="elasticPolicy"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "elasticPolicy": V1beta1TorchElasticPolicy.from_dict(
                    obj["elasticPolicy"]
                )
                if obj.get("elasticPolicy") is not None
                else None,
