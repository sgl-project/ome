...
class V1beta1TorchMLPolicyConfig(BaseModel):
    """
    TorchMLPolicyConfig represents a PyTorch runtime configuration.
    """ # noqa: E501
    elastic_policy: Optional[V1beta1TorchElasticPolicy] = Field(default=None, alias="elasticPolicy")
    num_proc_per_node: Optional[StrictStr] = Field(default=None, description="Number of processes per node. This value is inserted into the `--nproc-per-node` argument of the `torchrun` CLI. Supported values: `auto`, `cpu`, `gpu`, or int value. Defaults to `auto`.", alias="numProcPerNode")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "elasticPolicy": V1beta1TorchElasticPolicy.from_dict(obj["elasticPolicy"]) if obj.get("elasticPolicy") is not None else None,
