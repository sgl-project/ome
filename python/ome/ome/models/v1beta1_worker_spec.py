...
class V1beta1WorkerSpec(BaseModel):
    ...
    size: Optional[StrictInt] = Field(default=None, description="Size of the worker, this is the number of pods in the worker. Controls how many worker pod instances will be deployed for horizontal scaling.")
