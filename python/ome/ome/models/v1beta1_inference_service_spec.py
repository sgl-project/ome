        ...
        _obj = cls.model_validate(
            {
                ...
                "decoder": V1beta1DecoderSpec.from_dict(obj["decoder"])
                if obj.get("decoder") is not None
                else None,
                "engine": V1beta1EngineSpec.from_dict(obj["engine"])
                if obj.get("engine") is not None
                else None,
                "kedaConfig": V1beta1KedaConfig.from_dict(obj["kedaConfig"])
                if obj.get("kedaConfig") is not None
                else None,
                "model": V1beta1ModelRef.from_dict(obj["model"])
                if obj.get("model") is not None
                else None,
                "predictor": V1beta1PredictorSpec.from_dict(obj["predictor"])
                if obj.get("predictor") is not None
                else None,
                "router": V1beta1RouterSpec.from_dict(obj["router"])
                if obj.get("router") is not None
                else None,
                "runtime": V1beta1ServingRuntimeRef.from_dict(obj["runtime"])
