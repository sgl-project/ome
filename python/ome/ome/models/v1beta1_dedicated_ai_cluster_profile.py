...
class V1beta1DedicatedAIClusterProfile(BaseModel):
    ...
    status: Optional[Dict[str, Any]] = Field(default=None, description="DedicatedAIClusterProfileStatus defines the observed state of DedicatedAIClusterProfile")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1beta1DedicatedAIClusterProfileSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
