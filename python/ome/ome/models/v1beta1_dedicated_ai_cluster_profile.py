...
class V1beta1DedicatedAIClusterProfile(BaseModel):
    """
    ...
    spec: Optional[V1beta1DedicatedAIClusterProfileSpec] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "spec": V1beta1DedicatedAIClusterProfileSpec.from_dict(obj["spec"])
