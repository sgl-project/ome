...
class V1beta1MLPolicyConfig(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "mpi": V1beta1MPIMLPolicyConfig.from_dict(obj["mpi"])
                if obj.get("mpi") is not None
                else None,
                "torch": V1beta1TorchMLPolicyConfig.from_dict(obj["torch"])
                if obj.get("torch") is not None
                else None,
            }
        )
        return _obj
