...
class V1beta1ModelSizeRangeSpec(BaseModel):
    ...
    max: Optional[StrictStr] = Field(
        default=None, description="Maximum size of the model in bytes"
    )
    min: Optional[StrictStr] = Field(
        default=None, description="Minimum size of the model in bytes"
    )
