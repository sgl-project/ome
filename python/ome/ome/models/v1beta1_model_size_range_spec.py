...
class V1beta1ModelSizeRangeSpec(BaseModel):
    """
    ModelSizeRangeSpec defines the range of model sizes supported by this runtime
    """ # noqa: E501
    max: Optional[StrictStr] = Field(default=None, description="Maximum size of the model in bytes")
    min: Optional[StrictStr] = Field(default=None, description="Minimum size of the model in bytes")
