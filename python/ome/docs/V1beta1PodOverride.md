...
v1beta1_pod_override_instance = V1beta1PodOverride.from_json(json)
# print the JSON string representation of the object
print(V1beta1PodOverride.to_json())

# convert the object into a dict
v1beta1_pod_override_dict = v1beta1_pod_override_instance.to_dict()
# create an instance of V1beta1PodOverride from a dict
v1beta1_pod_override_from_dict = V1beta1PodOverride.from_dict(v1beta1_pod_override_dict)
```
