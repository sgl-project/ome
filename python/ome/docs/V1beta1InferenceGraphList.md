...
v1beta1_inference_graph_list_instance = V1beta1InferenceGraphList.from_json(json)
# print the JSON string representation of the object
print(V1beta1InferenceGraphList.to_json())

# convert the object into a dict
v1beta1_inference_graph_list_dict = v1beta1_inference_graph_list_instance.to_dict()
# create an instance of V1beta1InferenceGraphList from a dict
v1beta1_inference_graph_list_from_dict = V1beta1InferenceGraphList.from_dict(v1beta1_inference_graph_list_dict)
```
