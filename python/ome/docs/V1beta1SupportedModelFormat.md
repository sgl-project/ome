...
v1beta1_supported_model_format_instance = V1beta1SupportedModelFormat.from_json(json)
# print the JSON string representation of the object
print(V1beta1SupportedModelFormat.to_json())

# convert the object into a dict
v1beta1_supported_model_format_dict = v1beta1_supported_model_format_instance.to_dict()
# create an instance of V1beta1SupportedModelFormat from a dict
v1beta1_supported_model_format_from_dict = V1beta1SupportedModelFormat.from_dict(v1beta1_supported_model_format_dict)
```
