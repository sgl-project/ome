...
v1beta1_inference_graph_spec_instance = V1beta1InferenceGraphSpec.from_json(json)
# print the JSON string representation of the object
print(V1beta1InferenceGraphSpec.to_json())

# convert the object into a dict
v1beta1_inference_graph_spec_dict = v1beta1_inference_graph_spec_instance.to_dict()
# create an instance of V1beta1InferenceGraphSpec from a dict
v1beta1_inference_graph_spec_from_dict = V1beta1InferenceGraphSpec.from_dict(v1beta1_inference_graph_spec_dict)
```
