...
export default function ImportRuntimePage() {
  ...
  const validateYAML = (content: string) => {
    try {
      ...
      if (
        !parsed.kind ||
        (parsed.kind !== 'ClusterServingRuntime' && parsed.kind !== 'ServingRuntime')
      ) {
      ...
      <header className="relative border-b border-border/50 bg-card/50 backdrop-blur-sm animate-in">
        <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <p className="mt-2 text-muted-foreground max-w-2xl">
            Import a ClusterServingRuntime configuration from a local YAML file or remote GitHub
            repository
          </p>
        </div>
      </header>
          ...
          <div className="border-b border-border/50 px-6">
            <nav className="-mb-px flex gap-8">
              ...
              <button
                ...
                className={`relative py-4 px-1 text-sm font-medium transition-colors ${
                  method === 'url' ? 'text-primary' : 'text-muted-foreground hover:text-foreground'
                }`}
              >
                GitHub URL
                {method === 'url' && (
          ...
          <div className="p-6">
            ...
            {method === 'upload' && (
              <div className="space-y-6">
                ...
                {!yamlContent && (
                  <div>
                    <label className="block text-sm font-medium mb-3">Or paste YAML directly</label>
                    <textarea
                      value={yamlContent}
                      onChange={(e) => {
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="mt-2 text-xs text-gray-500">
                    Paste a GitHub URL pointing to a YAML file. Works with both github.com and
                  ...
                  <div className="rounded-lg bg-blue-50 border border-accent/20 p-3">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm text-accent/90">
                        YAML fetched successfully ({yamlContent.split('\n').length} lines)
                      </span>
                    </div>
                  </div>
                )}
              ...
              <div className="mt-6 space-y-4">
                ...
                <div className="rounded-lg border border-gray-200 bg-white overflow-hidden">
                  ...
                  <div className="p-6 space-y-6">
                    ...
                    <ModelFormatsDisplay
                      formats={parsedRuntime.spec?.supportedModelFormats || []}
                    />

                    {/* Protocol Versions */}
                    {parsedRuntime.spec?.protocolVersions &&
                      parsedRuntime.spec.protocolVersions.length > 0 && (
                        <div>
                          <h4 className="text-sm font-medium text-gray-900 mb-3">
                            Protocol Versions
                          </h4>
                          <div className="flex flex-wrap gap-2">
                            {parsedRuntime.spec.protocolVersions.map(
                          ...
                          {parsedRuntime.spec.routerConfig.runner && (
                            <div className="bg-white rounded-lg p-3 border border-accent/20">
                              <p className="text-xs font-medium text-gray-700 mb-2">
                                Container:{' '}
                                {parsedRuntime.spec.routerConfig.runner.name || 'router-container'}
                              </p>
                              <p className="text-xs text-gray-600 font-mono break-all mb-2">
                                Image: {parsedRuntime.spec.routerConfig.runner.image}
                              </p>
                              ...
                              {parsedRuntime.spec.routerConfig.runner.env &&
                                parsedRuntime.spec.routerConfig.runner.env.length > 0 && (
                                  <details className="mt-2">
                                    <summary className="text-xs font-medium text-accent cursor-pointer">
                                      Environment Variables (
                                      {parsedRuntime.spec.routerConfig.runner.env.length})
                                    </summary>
                                    <div className="mt-1 space-y-1 pl-2">
                                      {parsedRuntime.spec.routerConfig.runner.env.map(
                                        (env: any, i: number) => (
                    ...
                    {parsedRuntime.spec?.engineConfig && (
                      <div className="border-l-4 border-accent bg-accent/10 p-4">
                        ...
                        <div className="space-y-3">
                          ...
                          {parsedRuntime.spec.engineConfig.runner &&
                            !parsedRuntime.spec.engineConfig.leader && (
                              <div className="bg-white rounded-lg p-3 border border-accent/20">
                                <p className="text-xs font-bold text-accent/90 mb-2">
                                  🖥️ Single Node
                                </p>
                                <p className="text-xs font-medium text-gray-700 mb-1">
                                  Container: {parsedRuntime.spec.engineConfig.runner.name || 'N/A'}
                                </p>
                                <p className="text-xs text-gray-600 font-mono break-all mb-2">
                                  Image: {parsedRuntime.spec.engineConfig.runner.image || 'N/A'}
                                </p>
                                ...
                                {parsedRuntime.spec.engineConfig.runner.env &&
                                  Array.isArray(parsedRuntime.spec.engineConfig.runner.env) &&
                                  parsedRuntime.spec.engineConfig.runner.env.length > 0 && (
                                    <details className="mt-2">
                                      <summary className="text-xs font-medium text-accent cursor-pointer">
                                        🔧 Environment Variables (
                                        {parsedRuntime.spec.engineConfig.runner.env.length})
                                      </summary>
                                      <div className="mt-1 space-y-1 pl-2 max-h-40 overflow-y-auto">
                                        {parsedRuntime.spec.engineConfig.runner.env.map(
                                          (env: any, i: number) => (
                                            <p
                                              key={i}
                                ...
                                {parsedRuntime.spec.engineConfig.runner.command &&
                                  Array.isArray(parsedRuntime.spec.engineConfig.runner.command) && (
                                    <details className="mt-2">
                                      <summary className="text-xs font-medium text-accent cursor-pointer">
                                        💻 Command (
                                        {parsedRuntime.spec.engineConfig.runner.command.length}{' '}
                                        args)
                                      </summary>
                                ...
                                {parsedRuntime.spec.engineConfig.runner.args &&
                                  Array.isArray(parsedRuntime.spec.engineConfig.runner.args) &&
                                  parsedRuntime.spec.engineConfig.runner.args.length > 0 && (
                                    <details className="mt-2">
                                      <summary className="text-xs font-medium text-accent cursor-pointer">
                                        📝 Args (
                                        {parsedRuntime.spec.engineConfig.runner.args.length})
                                      </summary>
                                      <pre className="mt-1 text-xs text-gray-600 font-mono bg-gray-50 p-3 rounded overflow-x-auto max-h-60 whitespace-pre-wrap break-all leading-relaxed">
                                        {parsedRuntime.spec.engineConfig.runner.args
                                          .join(' ')
                            ...
                            <div className="bg-white rounded-lg p-3 border border-accent/20">
                              ...
                              {parsedRuntime.spec.engineConfig.leader.runner ? (
                                <>
                                  <p className="text-xs font-medium text-gray-700 mb-1">
                                    Container:{' '}
                                    {parsedRuntime.spec.engineConfig.leader.runner.name || 'N/A'}
                                  </p>
                                  <p className="text-xs text-gray-600 font-mono break-all mb-2">
                                    Image:{' '}
                                    {parsedRuntime.spec.engineConfig.leader.runner.image || 'N/A'}
                                  </p>
                                  <ResourceDisplay
                                    resources={
                                  ...
                                  />
                                  {parsedRuntime.spec.engineConfig.leader.runner.env &&
                                    Array.isArray(
                                      parsedRuntime.spec.engineConfig.leader.runner.env
                                    ) &&
                                    parsedRuntime.spec.engineConfig.leader.runner.env.length >
                                      0 && (
                                      <details className="mt-2">
                                        <summary className="text-xs font-medium text-accent cursor-pointer">
                                          🔧 Environment Variables (
                                        ...
                                        <div className="mt-1 space-y-1 pl-2 max-h-40 overflow-y-auto">
                                          {parsedRuntime.spec.engineConfig.leader.runner.env.map(
                                            (env: any, i: number) => (
                                              <p
                                                key={i}
                                                className="text-xs text-gray-600 font-mono break-all"
                                  ...
                                  {parsedRuntime.spec.engineConfig.leader.runner.command &&
                                    Array.isArray(
                                      parsedRuntime.spec.engineConfig.leader.runner.command
                                    ) && (
                                      <details className="mt-2">
                              ...
                              {parsedRuntime.spec.engineConfig.leader.nodeSelector &&
                                Object.keys(parsedRuntime.spec.engineConfig.leader.nodeSelector)
                                  .length > 0 && (
                                  <details className="mt-2">
                                    <summary className="text-xs font-medium text-accent cursor-pointer">
                                      🎯 Node Selector (
                            ...
                            <div className="bg-white rounded-lg p-3 border border-accent/20">
                              <div className="flex items-center justify-between mb-2">
                                ...
                                <span className="inline-flex items-center rounded-md bg-accent/20 px-2 py-1 text-xs font-medium text-accent">
                                  {parsedRuntime.spec.engineConfig.worker.size || 1} node
                                  {(parsedRuntime.spec.engineConfig.worker.size || 1) > 1
                                    ? 's'
                                    : ''}
                                </span>
                              </div>
                              {parsedRuntime.spec.engineConfig.worker.runner ? (
                                <>
                                  <p className="text-xs font-medium text-gray-700 mb-1">
                                    Container:{' '}
                                    {parsedRuntime.spec.engineConfig.worker.runner.name || 'N/A'}
                                  </p>
                                  <p className="text-xs text-gray-600 font-mono break-all mb-2">
                                    Image:{' '}
                                    {parsedRuntime.spec.engineConfig.worker.runner.image || 'N/A'}
                                  </p>
                                  <ResourceDisplay
                                    resources={
                                  ...
                                  />
                                  {parsedRuntime.spec.engineConfig.worker.runner.env &&
                                    Array.isArray(
                                      parsedRuntime.spec.engineConfig.worker.runner.env
                                    ) &&
                                    parsedRuntime.spec.engineConfig.worker.runner.env.length >
                                      0 && (
                                      <details className="mt-2">
                                        <summary className="text-xs font-medium text-accent cursor-pointer">
                                          🔧 Environment Variables (
                                        ...
                                        <div className="mt-1 space-y-1 pl-2 max-h-40 overflow-y-auto">
                                          {parsedRuntime.spec.engineConfig.worker.runner.env.map(
                                            (env: any, i: number) => (
                                              <p
                                                key={i}
                                                className="text-xs text-gray-600 font-mono break-all"
                                  ...
                                  {parsedRuntime.spec.engineConfig.worker.runner.command &&
                                    Array.isArray(
                                      parsedRuntime.spec.engineConfig.worker.runner.command
                                    ) && (
                                      <details className="mt-2">
                    ...
                    {parsedRuntime.spec?.decoderConfig && (
                      <div className="border-l-4 border-accent bg-accent/10 p-4">
                        ...
                        <div className="space-y-3">
                          {/* Single-node: Direct runner */}
                          {parsedRuntime.spec.decoderConfig.runner &&
                            !parsedRuntime.spec.decoderConfig.leader && (
                              <div className="bg-white rounded-lg p-3 border border-accent/20">
                                ...
                                <p className="text-xs font-medium text-gray-700 mb-1">
                                  Container: {parsedRuntime.spec.decoderConfig.runner.name || 'N/A'}
                                </p>
                                <p className="text-xs text-gray-600 font-mono break-all mb-2">
                                  Image: {parsedRuntime.spec.decoderConfig.runner.image || 'N/A'}
                                </p>
                                <ResourceDisplay
                                  resources={parsedRuntime.spec.decoderConfig.runner.resources}
                                />
                                {parsedRuntime.spec.decoderConfig.runner.env &&
                                  Array.isArray(parsedRuntime.spec.decoderConfig.runner.env) &&
                                  parsedRuntime.spec.decoderConfig.runner.env.length > 0 && (
                                    <details className="mt-2">
                                      <summary className="text-xs font-medium text-accent cursor-pointer">
                                        🔧 Environment Variables (
                                        {parsedRuntime.spec.decoderConfig.runner.env.length})
                                      </summary>
                                      <div className="mt-1 space-y-1 pl-2 max-h-40 overflow-y-auto">
                                        {parsedRuntime.spec.decoderConfig.runner.env.map(
                                          (env: any, i: number) => (
                                            <p
                                              key={i}
                                              className="text-xs text-gray-600 font-mono break-all"
                                ...
                                {parsedRuntime.spec.decoderConfig.runner.command &&
                                  Array.isArray(
                                    parsedRuntime.spec.decoderConfig.runner.command
                                  ) && (
                                    <details className="mt-2">
                                      <summary className="text-xs font-medium text-accent cursor-pointer">
                                        💻 Command (
                                        {parsedRuntime.spec.decoderConfig.runner.command.length}{' '}
                                        args)
                                      </summary>
                                      <pre className="mt-1 text-xs text-gray-600 font-mono bg-gray-50 p-3 rounded overflow-x-auto max-h-60 whitespace-pre-wrap break-all leading-relaxed">
                                        {parsedRuntime.spec.decoderConfig.runner.command
                                ...
                                {parsedRuntime.spec.decoderConfig.runner.args &&
                                  Array.isArray(parsedRuntime.spec.decoderConfig.runner.args) &&
                                  parsedRuntime.spec.decoderConfig.runner.args.length > 0 && (
                                    <details className="mt-2">
                                      <summary className="text-xs font-medium text-accent cursor-pointer">
                                        📝 Args (
                                        {parsedRuntime.spec.decoderConfig.runner.args.length})
                                      </summary>
                                      <pre className="mt-1 text-xs text-gray-600 font-mono bg-gray-50 p-2 rounded overflow-x-auto max-h-60">
                                        {parsedRuntime.spec.decoderConfig.runner.args.join(' ')}
                                      </pre>
                                    </details>
                                  )}
                              </div>
                            ...
                            <div className="bg-white rounded-lg p-3 border border-accent/20">
                              ...
                              {parsedRuntime.spec.decoderConfig.leader.runner ? (
                                <>
                                  <p className="text-xs font-medium text-gray-700 mb-1">
                                    Container:{' '}
                                    {parsedRuntime.spec.decoderConfig.leader.runner.name || 'N/A'}
                                  </p>
                                  <p className="text-xs text-gray-600 font-mono break-all mb-2">
                                    Image:{' '}
                                    {parsedRuntime.spec.decoderConfig.leader.runner.image || 'N/A'}
                                  </p>
                                  <ResourceDisplay
                                    resources={
                                  ...
                                  />
                                  {parsedRuntime.spec.decoderConfig.leader.runner.env &&
                                    Array.isArray(
                                      parsedRuntime.spec.decoderConfig.leader.runner.env
                                    ) &&
                                    parsedRuntime.spec.decoderConfig.leader.runner.env.length >
                                      0 && (
                                      <details className="mt-2">
                                        <summary className="text-xs font-medium text-accent cursor-pointer">
                                          🔧 Environment Variables (
                                        ...
                                        <div className="mt-1 space-y-1 pl-2 max-h-40 overflow-y-auto">
                                          {parsedRuntime.spec.decoderConfig.leader.runner.env.map(
                                            (env: any, i: number) => (
                                              <p
                                                key={i}
                                                className="text-xs text-gray-600 font-mono break-all"
                                  ...
                                  {parsedRuntime.spec.decoderConfig.leader.runner.command &&
                                    Array.isArray(
                                      parsedRuntime.spec.decoderConfig.leader.runner.command
                                    ) && (
                                      <details className="mt-2">
                              ...
                              {parsedRuntime.spec.decoderConfig.leader.nodeSelector &&
                                Object.keys(parsedRuntime.spec.decoderConfig.leader.nodeSelector)
                                  .length > 0 && (
                                  <details className="mt-2">
                                    <summary className="text-xs font-medium text-accent cursor-pointer">
                                      🎯 Node Selector (
                          ...
                          {parsedRuntime.spec.decoderConfig.worker && (
                            <div className="bg-white rounded-lg p-3 border border-accent/20">
                              <div className="flex items-center justify-between mb-2">
                                <p className="text-xs font-bold text-accent/90">👥 Worker Nodes</p>
                                <span className="inline-flex items-center rounded-md bg-accent/20 px-2 py-1 text-xs font-medium text-accent">
                                  {parsedRuntime.spec.decoderConfig.worker.size || 1} node
                                  {(parsedRuntime.spec.decoderConfig.worker.size || 1) > 1
                                    ? 's'
                                    : ''}
                                </span>
                              </div>
                              {parsedRuntime.spec.decoderConfig.worker.runner ? (
                                <>
                                  <p className="text-xs font-medium text-gray-700 mb-1">
                                    Container:{' '}
                                    {parsedRuntime.spec.decoderConfig.worker.runner.name || 'N/A'}
                                  </p>
                                  <p className="text-xs text-gray-600 font-mono break-all mb-2">
                                    Image:{' '}
                                    {parsedRuntime.spec.decoderConfig.worker.runner.image || 'N/A'}
                                  </p>
                                  <ResourceDisplay
                                    resources={
                                  ...
                                  />
                                  {parsedRuntime.spec.decoderConfig.worker.runner.env &&
                                    Array.isArray(
                                      parsedRuntime.spec.decoderConfig.worker.runner.env
                                    ) &&
                                    parsedRuntime.spec.decoderConfig.worker.runner.env.length >
                                      0 && (
                                      <details className="mt-2">
                                        <summary className="text-xs font-medium text-accent cursor-pointer">
                                          🔧 Environment Variables (
                                        ...
                                        <div className="mt-1 space-y-1 pl-2 max-h-40 overflow-y-auto">
                                          {parsedRuntime.spec.decoderConfig.worker.runner.env.map(
                                            (env: any, i: number) => (
                                              <p
                                                key={i}
                                                className="text-xs text-gray-600 font-mono break-all"
                                  ...
                                  {parsedRuntime.spec.decoderConfig.worker.runner.command &&
                                    Array.isArray(
                                      parsedRuntime.spec.decoderConfig.worker.runner.command
                                    ) && (
                                      <details className="mt-2">
                    ...
                    {parsedRuntime.spec?.containers &&
                      ...
                      !parsedRuntime.spec?.decoderConfig && (
                        <div className="border-l-4 border-gray-500 bg-gray-50 p-4">
                          <h4 className="text-sm font-medium text-gray-900 mb-3">
                            📦 Containers ({parsedRuntime.spec.containers.length})
                          </h4>
                          <div className="space-y-3">
                  ...
                  <div className="border border-gray-200 rounded-lg overflow-hidden">
                    ...
                    >
                      <span className="text-sm font-medium text-gray-700">
                        📄 YAML Content ({yamlContent.split('\n').length} lines)
                      </span>
                      <svg
