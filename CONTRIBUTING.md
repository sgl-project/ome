...
The Go tools require that you clone the repository to the `src/bitbucket.oci.oraclecorp.com/genaicore/ome` directory in your [`GOPATH`](https://github.com/golang/go/wiki/SettingGOPATH).
