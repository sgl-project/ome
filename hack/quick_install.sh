...
kubectl apply -f https://bitbucket.oci.oraclecorp.com/gen/ome/releases/download/${OME_VERSION}/${OME_CONFIG}
...
if [ ${MAJOR_VERSION} -eq 0 ] && [ ${MINOR_VERSION} -le 11 ]; then
    kubectl apply -f https://bitbucket.oci.oraclecorp.com/gen/ome/releases/download/${OME_VERSION}/ome-runtimes.yaml
else
    kubectl apply -f https://bitbucket.oci.oraclecorp.com/gen/ome/releases/download/${OME_VERSION}/ome-cluster-resources.yaml
fi
