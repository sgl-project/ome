...
TARGET_DIR="$GOPATH/src/bitbucket.oci.oraclecorp.com/genaicore/ome"
CURRENT_DIR=$(pwd)
...
go run k8s.io/kube-openapi/cmd/openapi-gen \
    --output-pkg bitbucket.oci.oraclecorp.com/genaicore/ome/pkg/openapi --output-dir "./pkg/openapi" \
