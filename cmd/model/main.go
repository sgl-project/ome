...
const (
	LeaderLockName          = "ome-controller-model-lock"
...
func GetOptions() Options {
	...
	flag.BoolVar(&opts.enableLeaderElection, "leader-elect", opts.enableLeaderElection,
		"Enable leader election for ome model controller. "+
			"Enabling this will ensure there is only one active ome model controller.")
...
func main() {
	...
	setupLog.Info("Initializing Model Controller", "gitVersion", version.GitVersion, "gitCommit", version.GitCommit)
	...
	// Start the Cmd
	setupLog.Info("Starting Model controller manager")
