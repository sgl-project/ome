...
func TestDefaultConfig(t *testing.T) {
	...
	testCmd.Flags().IntVar(&cfg.modelFileWriteConcurrency, "model-file-write-concurrency", 0, "model file write concurrency")
	...
	assert.Equal(t, 0, cfg.modelFileWriteConcurrency)
