...
const (
	LeaderLockName          = "ome-controller-benchmark-lock"
...
func GetOptions() Options {
	...
	flag.BoolVar(&opts.enableLeaderElection, "leader-elect", opts.enableLeaderElection,
		"Enable leader election for ome benchmark controller. "+
			"Enabling this will ensure there is only one active ome benchmark controller.")
...
func main() {
	...
	setupLog.Info("Initializing Benchmark Controller", "gitVersion", version.GitVersion, "gitCommit", version.GitCommit)
	...
	// Start the Cmd
	setupLog.Info("Starting Benchmark controller manager")
