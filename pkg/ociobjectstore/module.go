...
type OSDataStoreConfigWrapper struct {
	...
	// TODO: Rename group name to objectStorageConfigs; applies to consumers under training agent.
	OSDataStoreConfig *Config `group:"casperConfigs"`
}

// ProvideSourceOCIOSDataStore constructs a Config instance for the source OCI Object Storage
...
func ProvideSourceOCIOSDataStoreConfig(v *viper.Viper, logger logging.Interface) (OSDataStoreConfigWrapper, error) {
	...
	if err != nil {
		return OSDataStoreConfigWrapper{}, fmt.Errorf("error reading download agent config: %w", err)
	}
...
type appParams struct {
	...
	// TODO: rename group to objectStorageConfigs, including code under replica agent and training agent
