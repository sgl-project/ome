...
import (
	...
	"github.com/sgl-project/sgl-ome/pkg/openaisdk/apierror"
	"github.com/sgl-project/sgl-ome/pkg/openaisdk/apiform"
	"github.com/sgl-project/sgl-ome/pkg/openaisdk/apiquery"
)
...
func getDefaultHeaders() map[string]string {
	return map[string]string{
		"User-Agent": fmt.Sprintf("OpenAI/Go %s", PackageVersion),
	}
}
...
func NewRequestConfig(ctx context.Context,
	method string,
	u string,
	body interface{},
	dst interface{},
	opts ...func(config *RequestConfig) error) (*RequestConfig, error) {
