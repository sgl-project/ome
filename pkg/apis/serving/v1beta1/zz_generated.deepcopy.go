...
func (in *AssociationUsage) DeepCopyInto(out *AssociationUsage) {
	*out = *in
	...
	if in.BorrowedQuota != nil {
		in, out := &in.BorrowedQuota, &out.BorrowedQuota
		*out = make(v1.ResourceList, len(*in))
		for key, val := range *in {
			(*out)[key] = val.DeepCopy()
		}
...
func (in *BenchmarkJobSpec) DeepCopyInto(out *BenchmarkJobSpec) {
	*out = *in
	in.InferenceServiceReference.DeepCopyInto(&out.InferenceServiceReference)
...
func (in *InferenceServiceReference) DeepCopyInto(out *InferenceServiceReference) {
	*out = *in
	if in.K8sInferenceService != nil {
		in, out := &in.K8sInferenceService, &out.K8sInferenceService
		*out = new(K8sInferenceServiceReference)
		**out = **in
	}
	if in.Endpoint != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *K8sInferenceServiceReference) DeepCopyInto(out *K8sInferenceServiceReference) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new K8sInferenceServiceReference.
func (in *K8sInferenceServiceReference) DeepCopy() *K8sInferenceServiceReference {
	if in == nil {
		return nil
	}
	out := new(K8sInferenceServiceReference)
...
func (in *Storage) DeepCopyInto(out *Storage) {
	*out = *in
	if in.OSStorageSpec != nil {
		in, out := &in.OSStorageSpec, &out.OSStorageSpec
		*out = new(OSStorage)
		**out = **in
	}
	if in.PVCStorageSpec != nil {
		in, out := &in.PVCStorageSpec, &out.PVCStorageSpec
		*out = new(PVCStorage)
		**out = **in
	}
}
...
func (in *TrainingJobSpec) DeepCopyInto(out *TrainingJobSpec) {
	*out = *in
	...
	if in.TrainingFramework != nil {
		in, out := &in.TrainingFramework, &out.TrainingFramework
		*out = new(TrainingFramework)
		(*in).DeepCopyInto(*out)
	}
	in.Hyperparameters.DeepCopyInto(&out.Hyperparameters)
