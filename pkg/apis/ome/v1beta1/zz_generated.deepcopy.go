...
func (in *InferenceServiceSpec) DeepCopyInto(out *InferenceServiceSpec) {
	*out = *in
	...
	if in.DraftModel != nil {
		in, out := &in.DraftModel, &out.DraftModel
		*out = new(ModelRef)
		(*in).DeepCopyInto(*out)
	}
	if in.Runtime != nil {
...
func (in *ServingRuntimeSpec) DeepCopyInto(out *ServingRuntimeSpec) {
	*out = *in
	...
	if in.DraftModelSizeRange != nil {
		in, out := &in.DraftModelSizeRange, &out.DraftModelSizeRange
		*out = new(ModelSizeRangeSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.SupportedDraftModelFormats != nil {
		in, out := &in.SupportedDraftModelFormats, &out.SupportedDraftModelFormats
		*out = make([]SupportedDraftModelFormat, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SupportedDraftModelFormat) DeepCopyInto(out *SupportedDraftModelFormat) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SupportedDraftModelFormat.
func (in *SupportedDraftModelFormat) DeepCopy() *SupportedDraftModelFormat {
	if in == nil {
		return nil
	}
	out := new(SupportedDraftModelFormat)
	in.DeepCopyInto(out)
	return out
}
