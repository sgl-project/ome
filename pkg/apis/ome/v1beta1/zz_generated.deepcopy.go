...
func (in *AIPlatformConfig) DeepCopyInto(out *AIPlatformConfig) {
	*out = *in
	out.SecretConfig = in.SecretConfig
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AIPlatformConfig.
func (in *AIPlatformConfig) DeepCopy() *AIPlatformConfig {
	if in == nil {
		return nil
	}
	out := new(AIPlatformConfig)
	in.DeepCopyInto(out)
	return out
}
