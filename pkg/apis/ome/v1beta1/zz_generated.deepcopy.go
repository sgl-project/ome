...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServingAdapter) DeepCopyInto(out *ServingAdapter) {
	*out = *in
	if in.Env != nil {
		in, out := &in.Env, &out.Env
		*out = make([]corev1.EnvVar, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServingAdapter.
func (in *ServingAdapter) DeepCopy() *ServingAdapter {
	if in == nil {
		return nil
	}
	out := new(ServingAdapter)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ServingRuntimeSpec) DeepCopyInto(out *ServingRuntimeSpec) {
	*out = *in
	...
	if in.ServingAdapter != nil {
		in, out := &in.ServingAdapter, &out.ServingAdapter
		*out = new(ServingAdapter)
		(*in).DeepCopyInto(*out)
	}
}
