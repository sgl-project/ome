...
func (c *FakeServingRuntimes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ServingRuntime, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(servingruntimesResource, c.ns, name), &v1beta1.ServingRuntime{})
...
func (c *FakeServingRuntimes) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ServingRuntimeList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(servingruntimesResource, servingruntimesKind, c.ns, opts), &v1beta1.ServingRuntimeList{})
...
func (c *FakeServingRuntimes) Create(ctx context.Context, servingRuntime *v1beta1.ServingRuntime, opts v1.CreateOptions) (result *v1beta1.ServingRuntime, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(servingruntimesResource, c.ns, servingRuntime), &v1beta1.ServingRuntime{})
...
func (c *FakeServingRuntimes) Update(ctx context.Context, servingRuntime *v1beta1.ServingRuntime, opts v1.UpdateOptions) (result *v1beta1.ServingRuntime, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(servingruntimesResource, c.ns, servingRuntime), &v1beta1.ServingRuntime{})
...
func (c *FakeServingRuntimes) UpdateStatus(ctx context.Context, servingRuntime *v1beta1.ServingRuntime, opts v1.UpdateOptions) (*v1beta1.ServingRuntime, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(servingruntimesResource, "status", c.ns, servingRuntime), &v1beta1.ServingRuntime{})
...
func (c *FakeServingRuntimes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ServingRuntime, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(servingruntimesResource, c.ns, name, pt, data, subresources...), &v1beta1.ServingRuntime{})
