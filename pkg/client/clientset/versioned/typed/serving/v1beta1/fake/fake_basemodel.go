...
func (c *FakeBaseModels) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.BaseModel, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(basemodelsResource, c.ns, name), &v1beta1.BaseModel{})
...
func (c *FakeBaseModels) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.BaseModelList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(basemodelsResource, basemodelsKind, c.ns, opts), &v1beta1.BaseModelList{})
...
func (c *FakeBaseModels) Create(ctx context.Context, baseModel *v1beta1.BaseModel, opts v1.CreateOptions) (result *v1beta1.BaseModel, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(basemodelsResource, c.ns, baseModel), &v1beta1.BaseModel{})
...
func (c *FakeBaseModels) Update(ctx context.Context, baseModel *v1beta1.BaseModel, opts v1.UpdateOptions) (result *v1beta1.BaseModel, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(basemodelsResource, c.ns, baseModel), &v1beta1.BaseModel{})
...
func (c *FakeBaseModels) UpdateStatus(ctx context.Context, baseModel *v1beta1.BaseModel, opts v1.UpdateOptions) (*v1beta1.BaseModel, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(basemodelsResource, "status", c.ns, baseModel), &v1beta1.BaseModel{})
...
func (c *FakeBaseModels) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.BaseModel, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(basemodelsResource, c.ns, name, pt, data, subresources...), &v1beta1.BaseModel{})
