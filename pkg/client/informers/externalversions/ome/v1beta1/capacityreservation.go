...
type CapacityReservationInformer interface {
	...
	Lister() omev1beta1.CapacityReservationLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.OmeV1beta1().CapacityReservations(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OmeV1beta1().CapacityReservations(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OmeV1beta1().CapacityReservations(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OmeV1beta1().CapacityReservations(namespace).Watch(ctx, options)
			},
		},
		&apisomev1beta1.CapacityReservation{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *capacityReservationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisomev1beta1.CapacityReservation{}, f.defaultInformer)
}

func (f *capacityReservationInformer) Lister() omev1beta1.CapacityReservationLister {
	return omev1beta1.NewCapacityReservationLister(f.Informer().GetIndexer())
}
