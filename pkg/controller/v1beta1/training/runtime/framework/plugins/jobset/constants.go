...
const (
	...
	// TODO: Add validation to check that initializer Pod has the correct volume.
...
var (
	// ContainerBusyBox This is the temporary container that we use in the initializer ReplicatedJob.
	// TODO: Once JobSet supports execution policy, we can remove it.
	...
	// TODO: Add validation to check that initializer ReplicatedJob has the following volumes.
	VolumeMountModelInitializer = corev1.VolumeMount{
		Name:      VolumeNameInitializer,
		MountPath: "/workspace/model",
	}

	// VolumeMountDatasetInitializer is the volume mount for the dataset initializer container.
	...
	// TODO: We should make VolumeSource configurable.
