...
func (plpc *PeftLauncherPodConfig) podConfig() error {
	...
	if err == nil && dedicatedAiClusterResource != nil {
		podconfig.SetNodeAffinityIfNecessary(plpc.podSpec, dedicatedAiClusterResource)
	}
...
func (plpc *PeftLauncherPodConfig) trainingContainerConfig() error {
	...
	if err == nil && dedicatedAiClusterResource != nil {
		...
		podconfig.SetGpuResourceLimitsIfNecessary(plpc.trainingContainer, dedicatedAiClusterResource)
	}
	return nil
}
