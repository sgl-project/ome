...
func (r *TrainingJobReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err == nil && dedicatedAiClusterResource != nil {
		...
		profile := &v1beta1.DedicatedAIClusterProfile{}
...
func runtimeRefToGroupKind(runtimeRef v1beta1.RuntimeRef) schema.GroupKind {
...
func (r *TrainingJobReconciler) reconcilePVPVC(trainjob *v1beta1.TrainingJob, baseModel opensourcev1beta1.BaseModelSpec) (ctrl.Result, error) {
