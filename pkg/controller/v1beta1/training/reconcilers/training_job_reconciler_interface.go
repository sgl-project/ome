...
func reconcileK8sJob(trainingJob *v1beta1.TrainingJob, client client.Client, scheme *runtime.Scheme, podSpec *v1.PodSpec, replicaCount int32, objectMeta metav1.ObjectMeta) (ctrl.Result, error) {
...
type MultiplePodTrainingReconciler interface {
	Reconcile(trainingJob *v1beta1.TrainingJob) (ctrl.Result, error)
}
